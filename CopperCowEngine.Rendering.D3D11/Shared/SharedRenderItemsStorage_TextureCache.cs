...
namespace CopperCowEngine.Rendering.D3D11.Shared
{
    internal partial class SharedRenderItemsStorage
    {
        ...
        // TODO: Create debug cube map
        private Texture2D DebugCubeTexture => LoadCubeTextureAsset("SkyboxCubeMap", out _);

        // ReSharper disable once InconsistentNaming
        public ShaderResourceView BRDFxLookUpTable => LoadTextureShaderResourceView("StandardBRDFxLUT");
        ...
        public Texture2D LoadTextureAsset(string assetName)
        {
            ...
            var optionFlags = asset.Data.GetMips ? ResourceOptionFlags.GenerateMipMaps : ResourceOptionFlags.None;
        ...
        public ShaderResourceView LoadTextureShaderResourceView([NotNull] string assetName, bool isCubeMap = false)
        {
            ...
            else
            {
                ...
                if (texture.Description.MipLevels != 1)
                {
