...
namespace CopperCowEngine.Rendering.D3D11.Loaders
{
    internal static class TextureImporter
    {
        ...
        public static TextureAssetData ImportTexture(string path, bool forceSRgb)
        {
        ...
        public static TextureCubeAssetData ImportCubeTexture(string path)
        {
            ...
            return new TextureCubeAssetData()
            {
                ...
                ChannelsCount = 4,
                BytesPerChannel = 1,
                ColorSpace = ColorSpaceType.Gamma,
