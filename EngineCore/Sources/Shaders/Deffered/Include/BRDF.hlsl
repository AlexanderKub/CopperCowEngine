...
#include "../../CommonsInclude/CommonMath.hlsl"

// UE4 BRDF, Copyright 1998-2018 Epic Games, Inc. All Rights Reserved.
struct BxDFContext
{
    float NoV;
    float NoL;
...
half3 EnvBRDF(half3 SpecularColor, half Roughness, half NoV)
{
    ...
    float2 AB = 1;//Texture2DSampleLevel(PreIntegratedGF, PreIntegratedGFSampler, float2(NoV, Roughness), 0).rg;
...
#endif // __DEPENDENCY_HLSL_BRDF__