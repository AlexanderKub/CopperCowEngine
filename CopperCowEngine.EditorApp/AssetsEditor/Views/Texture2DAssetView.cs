...
namespace CopperCowEngine.EditorApp.AssetsEditor.Views
{
    internal class Texture2DAssetView : BaseAssetView
    {
        ...
        public override void Init(PreviewEngine engine)
        {
            ...
            RendererComponent.SetMeshAndMaterial(AssetsLoader.GetMeshInfo(AssetsLoader.PrimitivesMesh.Cube),
                AssetsLoader.GetMaterialInfo(TestMaterial));
        ...
        public override void Show(string assetName)
        {
            ...
            Texture2DAsset asset = AssetsManager.GetManager().LoadAsset<Texture2DAsset>(assetName);
